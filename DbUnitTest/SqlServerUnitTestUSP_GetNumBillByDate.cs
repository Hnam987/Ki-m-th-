...
{
    [TestClass()]
    public class SqlServerUnitTestUSP_GetNumBillByDate : SqlDatabaseTestClass
    {

        public SqlServerUnitTestUSP_GetNumBillByDate()
        {
            InitializeComponent();
        }
        ...
        [TestMethod()]
        public void dbo_USP_GetNumBillByDateTest()
        {
            SqlDatabaseTestActions testActions = this.dbo_USP_GetNumBillByDateTestData;
        ...
        private SqlDatabaseTestActions dbo_USP_GetNumBillByDateTestData;
    }
}
